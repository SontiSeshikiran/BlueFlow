        ...
        start: function () {
            ...
            $.get('/dates', _init)
                .fail(function (jqXHR, textStatus, errorThrown) {
                    alert('Failed to load initial data (/dates): ' + textStatus + ' - ' + errorThrown);
                    console.error('Initial data load failed', jqXHR, textStatus, errorThrown);
                    document.getElementById('loading-msg').style.display = 'block';
                    document.getElementById('loading-msg').innerHTML = 'Error loading data: ' + errorThrown + '<br>Check server logs.';
                });
        },
        about: function () {
